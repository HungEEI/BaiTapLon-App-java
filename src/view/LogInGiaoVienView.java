...
import controller.LogInGiaoVIenController;
import model.UserDAO;

public class LogInGiaoVienView extends JFrame {
	...
	public LogInGiaoVienView() {
		...
		ActionListener action = new LogInGiaoVIenController(this);
		
		JLabel jLabel = new JLabel("ĐĂNG NHẬP GIÁO VIÊN");
